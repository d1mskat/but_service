...
class Order(models.Model):
	...
	def save(self, *args, **kwargs):
		...
		DATA = '<?xml version="1.0" encoding="utf-8" ?><request><operation>SENDSMS</operation><message start_time="AUTO" end_time="AUTO" lifetime="4" rate="120" desc="My first campaign " source="ipvideo"><body>'+mess+'</body><recipient>380962983764</recipient></message></request>'
